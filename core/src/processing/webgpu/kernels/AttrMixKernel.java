...
public class AttrMixKernel extends Kernel {
    ...
    public AttrMixKernel target(PBuffer buf) { compute.set("op_a", buf); return this; }
    /** Lerp-toward value (read-only). */
    public AttrMixKernel rhs(PBuffer buf)    { compute.set("op_b", buf); return this; }
    /** Per-particle weight in [0, 1] (read-only). */
    public AttrMixKernel weight(PBuffer buf) { compute.set("op_t", buf); return this; }
